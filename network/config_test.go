...
import (
	...
	"github.com/axiacoin/axia-network-v2-runner/k8s"
...
func TestConfigMarshalJSON(t *testing.T) {
	jsonNetcfg := "{\"implSpecificConfig\":\"\",\"genesis\":\"in the beginning there was a token\",\"nodeConfigs\":[{\"implSpecificConfig\":{\"binaryPath\":\"/tmp/some/file/path\"},\"name\":\"node0\",\"isBeacon\":true,\"stakingKey\":\"key123\",\"stakingCert\":\"cert123\",\"configFile\":\"config-file-blablabla1\",\"axchainConfigFile\":\"axchain-config-file-blablabla1\",\"flags\":{\"flag-one\":\"val-one\",\"flag-two\":2}},{\"implSpecificConfig\":{\"apiVersion\":\"0.99.999\",\"identifier\":\"k8s-node-1\",\"image\":\"therepo/theimage\",\"kind\":\"imaginary\",\"namespace\":\"outer-space\",\"tag\":\"omega\"},\"name\":\"node1\",\"isBeacon\":false,\"stakingKey\":\"key456\",\"stakingCert\":\"cert456\",\"configFile\":\"config-file-blablabla2\",\"axchainConfigFile\":\"axchain-config-file-blablabla2\",\"flags\":{\"flag-one\":\"val-one\",\"flag-two\":2}},{\"implSpecificConfig\":{\"binaryPath\":\"/tmp/some/other/path\"},\"name\":\"node2\",\"isBeacon\":false,\"stakingKey\":\"key789\",\"stakingCert\":\"cert789\",\"configFile\":\"config-file-blablabla3\",\"axchainConfigFile\":\"axchain-config-file-blablabla3\",\"flags\":{\"flag-one\":\"val-one\",\"flag-two\":2}}],\"logLevel\":\"DEBUG\",\"name\":\"abcxyz\",\"backend\":\"k8s\",\"flags\":{\"flag-three\":\"val-three\"}}"
		...
		NodeConfigs: []node.Config{
			{
				...
				AXChainConfigFile:   "axchain-config-file-blablabla1",
			...
			},
			{
				...
				AXChainConfigFile:   "axchain-config-file-blablabla2",
				Flags: map[string]interface{}{
					"flag-one": "val-one",
					"flag-two": float64(2),
				},
			},
			{
				...
				AXChainConfigFile:   "axchain-config-file-blablabla3",
				Flags: map[string]interface{}{
					"flag-one": "val-one",
					"flag-two": float64(2),
				},
