...
import (
	...
	"github.com/axiacoin/axia/utils/beacon"
	"github.com/axiacoin/axia/utils/constants"
	"github.com/axiacoin/axia/utils/ips"
...
const (
	...
	rootDirPrefix         = "axia-network-runner-"
	defaultDbSubdir       = "db"
...
func makeNodeDir(log logging.Logger, rootDir, nodeName string) (string, error) {
	...
	// [nodeRootDir] is where this node's config file, AXChain config file,
