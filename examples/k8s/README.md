# Kubernetes deployment of an axia network runner 
...
This implementation can be found at [axia-operator](https://github.com/ava-labs/axia-operator).
...
6. **Run the axia-operator locally**
   6a. Clone the repository: `github.com/ava-labs/axia-operator`
